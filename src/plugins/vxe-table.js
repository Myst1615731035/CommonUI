...
export const $XModal = VXETable.modal;
export const $XPrint = VXETable.print;
export const $XSaveFile = VXETable.saveFile;
export const $XReadFile = VXETable.readFile;

export const installVxeTable = app => {
	app.use(VXETable);
